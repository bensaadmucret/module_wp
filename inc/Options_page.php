...
class Options_page
{
    ...
    public function dcwd_pr_services_options()
    {
        ...
        $cmb_options->add_field(array(
            'desc' => "Interface d'administration du module.",
            'type' => 'title',
            'id'   => 'options_title'
        ));
        ...
        $cmb_options->add_group_field($pr_services_items_group_id, array(
            'name' => 'Ajouté un champs user',
            'id'   => 'service_name',
            'desc' => 'keys de la méta',
            'type' => 'text',
            'attributes' => array(
                'required' => 'required',
            ),
        ...
        'id'           => "gravityform",
        'title'        => __('Metabox pour gravity form', 'cmb2'),
        'object_types' => array( 'options-page' ),
        'context'      => 'normal',
        'priority'     => 'default',
        ));
        ...
        $cmb_options->add_field(array(
        'name' => __('ID Gravity Form inscription', 'cmb2'),
        'id' =>  'id_gravityform_inscription',
        'type' => 'text_small',
        ));
        $cmb_options->add_field(array(
        'name' => __('ID Gravity Form mise à jour', 'cmb2'),
        'id' =>  'id_gravityform_update',
        'type' => 'text_small',
        ));
    }
